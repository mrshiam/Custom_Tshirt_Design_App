var customTshirtDesign = angular.module('customTshirtDesign', []);

customTshirtDesign.config(function($interpolateProvider) {
  $interpolateProvider
    .startSymbol('{[')
    .endSymbol(']}');
});

customTshirtDesign.directive('bindValueTo', function() {
  return {
    restrict: 'A',
...
customTshirtDesign.directive('objectButtonsEnabled', function() {
  return {
    restrict: 'A',
